/**
 * The weekly check-in: six quick probes a grown-up runs away from the screen and scores by hand.
 * They cover rote counting (which no game tests) and cross-check the games with real objects.
 */
export type ProbeId = 'rote' | 'objects' | 'subitising' | 'numerals' | 'compare' | 'adding';
